...
class _PayBillsPageState extends State<PayBillsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 48, 118, 223), // Banking theme
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 48, 118, 223),
        elevation: 0,
        title: const Text(
          'Pay Bills',
          style: TextStyle(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: 'Easypay', child: Text('Easypay')),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color.fromARGB(237, 6, 223, 176),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _detailText('Amount', 'Rs ${amount.toStringAsFixed(2)}'),
