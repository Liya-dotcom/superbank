...
class MobileRechargePage extends StatelessWidget {
      ...
      body: Column(
        children: [
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  borderSide: const BorderSide(color: Color.fromARGB(237, 6, 223, 176),),
          ...
          Expanded(
            child: ListView(
              children: [
                _buildRecipientTile(context, "Liyabona Thebe"),
                _buildRecipientTile(context, "Vuyolwethu Thebe"),
                _buildRecipientTile(context, "Cwegest Zipo"),
                _buildRecipientTile(context, "Ngcalisto Khai"),
                _buildRecipientTile(context, "Brooklyn Simmons"),
                _buildRecipientTile(context, "John Doe"),
                _buildRecipientTile(context, "Jenny Bemson"),
                _buildRecipientTile(context, "Queen Smith"),
  ...
  Widget _buildBottomNavigationBar() {
    return BottomNavigationBar(
      ...
      selectedItemColor: const Color.fromARGB(237, 6, 223, 176),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10),
                    side: const BorderSide(color: Color.fromARGB(237, 6, 223, 176)),
                  ),
                ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  foregroundColor: const Color.fromARGB(237, 6, 223, 176),
                  padding:
                      const EdgeInsets.symmetric(vertical: 12, horizontal: 40),
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10)),
